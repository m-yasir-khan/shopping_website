                ...
                <div className='wemonCollectionDiv' >
                    {
                        this.state.productdisplay === "inline-flex" ? null :
                            <>
                                <div>
                                    <h2 className='WomenHeading'>Kids Collection</h2>
                                </div>

                                <div className='cardsDiv'>
                                    {/* <div className='card '>
                            <img className='produCtoff' src={ProductB} />
                            <p className='outoFF'>Out Off Stock</p>
                                    ...
                                    <div className='cardOverlay' >
                                        ...
                                        <div className="CArdAbout">
                                            ...
                                            <p className='overlayText'>
                                                Find stunning Kid's cocktail dresses and part dresses.
